...
<body>
    <div class="login__container">
        ...
        <form class="login__form" runat="server">
            ...
            <asp:TextBox ID="userTextbox" runat="server" required="required"></asp:TextBox>

            <asp:Label ID="Label2" runat="server" Text="Contraseña" ForeColor="#31B1E5" Font-Bold="True"></asp:Label>
            <asp:TextBox id="passwordTextbox" TextMode="password" runat="server" required="required"></asp:TextBox>
