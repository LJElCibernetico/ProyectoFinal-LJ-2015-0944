<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rDepartamentos.aspx.cs" Inherits="ProyectoFinal_Web.pages.Registros.rDepartamentos" %>
...
<body>
    <div class="container" runat="server">
		<div class="form__top" runat="server">
			<h2>Registro de <span>Departamentos</span></h2>
		</div>		
		<form class="form__reg" runat="server">
            ...
            <asp:TextBox class="input" ID="TextBoxDep" placeholder="Departamento" runat="server"></asp:TextBox>
