...
namespace ProyectoFinal_Aplicada2.pages.Registros
{
    public partial class rClientes : System.Web.UI.Page
    {
        ...
        private void ListTiposDeClientes()
        {
            RepositorioBase<TiposDeClientes> rep = new RepositorioBase<TiposDeClientes>();
            DropDownListTipoCliente.DataSource = rep.GetList(x => true);
            DropDownListTipoCliente.DataValueField = "IdTipoDeCliente";
            DropDownListTipoCliente.DataTextField = "Tipo";
            DropDownListTipoCliente.DataBind();
            DropDownListTipoCliente.Items.Insert(0, new ListItem("", ""));
        }
        ...
        private void ClearAll()
        {
            ...
            DropDownListTipoCliente.Text = String.Empty;
        ...
        private Clientes LlenaClase()
        {
            ...
            return new Clientes(
                ComprobarID(id),
                int.Parse(DropDownListTipoCliente.SelectedValue),
                TextBoxNombre.Text,
        ...
        {
            DropDownListTipoCliente.Text = cliente.IdTipoDeCliente.ToString();
